package com.example.uas_dpm_2011500040

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.*

class MenginputDataDosen : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_menginput_data_dosen)
        ...
        btnSimpan.setOnClickListener {
            if ("${etNIDN.text}".isNotEmpty() && "${etNmDosen.text}".isNotEmpty() &&
                ...
                val db = Database(this@MenginputDataDosen)
                db.Nidn = "${etNIDN.text}"
